package io.github.quiethappiness.lua.manager.domain.service.aop;
...
import static io.github.quiethappiness.lua.manager.domain.service.manager.AbstractLuaScriptManager.LOCAL_SEPARATOR;
...
public class LuaScriptServiceAop
{
	 ...
	 */
	@Pointcut("@within(io.github.quiethappiness.lua.manager.types.annotations.LuaScriptPath)")
