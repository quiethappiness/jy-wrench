...
import io.github.quiethappiness.wrench.util.design_framework.multi_tree.valobj.RuleTreeNodeLineVO;
import io.github.quiethappiness.wrench.util.design_framework.multi_tree.valobj.RuleTreeNodeVO;
...
public class DecisionTreeEngine<PT,PR> implements IDecisionTreeEngine<PT, PR>
{
	...
	public String nextNode(Object matterValue, List<RuleTreeNodeLineVO<?, ?>> treeNodeLineVOList)
	{
	...
	public boolean decisionLogic(Object matterValue, RuleTreeNodeLineVO<?, ?> nodeLine)
	{
		if (nodeLine == null)
		{
			return false;
		...
		RuleTreeNodeLineVO.SafeDecisionFunction decisionFunction = nodeLine.getSafeDecisionFunction();
		Object ruleLimitValue = nodeLine.getRuleLimitValue();
