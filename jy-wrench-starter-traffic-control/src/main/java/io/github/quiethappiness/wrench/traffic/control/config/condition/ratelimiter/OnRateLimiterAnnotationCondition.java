...
import static io.github.quiethappiness.wrench.traffic.control.config.condition.ConditionUtil.isAnnotationPresentOnAnyBean;
import static io.github.quiethappiness.wrench.traffic.control.config.condition.ConditionUtil.isConfigurationClass;

// 条件2：检查是否存在@EnableMethodExtension注解
@Slf4j
public class OnRateLimiterAnnotationCondition extends SpringBootCondition
{
	@Override
