package io.github.quiethappiness.wrench.rate.limiter.domain.service.tree.func;
...
public class SlidingWindowRateLimiter
{
	...
	@Autowired
	private ILuaScriptManager scriptManager;
	...
	{
		return dynamicConfigCenterAutoProperties.getSystem()+ MAO_HAO + getClass().getSimpleName() + PREFIX_RATE_LIMIT_SUFFIX + key;
	}
}
